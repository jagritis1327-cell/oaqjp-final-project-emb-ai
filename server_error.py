...
from Emotion_Detection.emotion_detection import emotion_detector # Import the emotion_detector function from the EmotionDetection package
...
if __name__ == '__main__':
    app.run(host='localhost', port=5001, debug=True) # Run the Flask application on localhost at port 5000 with debugging enabled